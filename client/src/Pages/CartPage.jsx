  ...
  return (
    clientSecret && (
      <Elements stripe={stripePromise} options={options}>
        ...
        <Div100vh className="transition-transform duration-1000" style={{ transform: formOpen && `translateY(-100%)` }}>
          ...
          <Div100vh className="z-30 w-full overflow-y-auto transition-transform duration-1000">
            <Form
              formOpen={formOpen}
