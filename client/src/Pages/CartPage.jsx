    ...
    clientSecret && (
      <Elements stripe={stripePromise} options={options}>
        ...
        <Div100vh
          ...
          className="page pt-16 md:pt-24 relative w-screen overflow-y-hidden font-cabin flex flex-col items-center justify-center bg-sound"
        >
            ...
            <div className="h-full w-full flex flex-col md:flex-row">
              <div className="h-full w-full md:w-3/5">
                <div
                  ...
                  style={{
                    transform: formOpen ? `translateY(-${responsiveHeight}vh)` : formValidated && "translateY(-100vh)",
                  }}
                >
                  <CartContainer
