...
const CartRecap = ({ formValidated, formOpen, toggleForm, handleForm, totalPrice }) => {
  ...
  return (
    <div
      ...
      className="recap w-full md:w-5/6 lg:w-2/3  bottom-0 md:top-0 md:my-auto md:left-10 z-30 flex flex-col items-center justify-center gap-4 md:gap-0 md:justify-evenly bg-black md:bg-white text-white md:text-gray-900 p-16 md:p-8 md:shadow"
    >
