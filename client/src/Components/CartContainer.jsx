    ...
    <div className="cart-container h-full w-full relative flex flex-col items-center justify-start md:items-end space-y-4 text-gray-900 bg-sound">
      {items.length !== 0 && (
        <div
          ...
          className="w-full flex flex-col items-start justify-center md:flex-row md:items-center md:justify-between space-y-2 md:space-x-0 pt-4 md:pt-0 pl-4 md:pl-10"
        >
      ...
      {items.length === 0 ? (
        ...
        >
          <div className="items overflow-y-auto scrollbar-cart h-max w-11/12 md:w-full flex flex-col items-center justify-start space-y-4">
            {items.map((item, i) => (
              <div
                key={i}
                style={{
              ...
              >
                ...
                <div className="details h-full w-full md:w-1/3 flex items-center justify-center space-x-2">
