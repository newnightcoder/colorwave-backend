...
const Form = ({
  ...
  return (
    <div
      ...
      className="form-container pt-16 h-full w-full z-30 relative flex flex-col items-center justify-center md:justify-start transition duration-300 text-gray-900"
    >
