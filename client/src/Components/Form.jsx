...
const Form = ({
  ...
  return (
    <div
      ...
      className="form-container pt-36 md:pt-32 h-full w-full z-30 relative flex flex-col items-center justify-center gap-2 md:gap-4 2xl:gap-8 md:justify-start transition duration-300 text-gray-900"
    >
